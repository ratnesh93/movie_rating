...
urlpatterns = [
    ...
    path(
        "getMovieRatingByName/<str:movie_title>",
        views.getMovieRatingByName,
        name="getMovieRatingByName",
    ),
    path(
        "getMovieRatingById/<uuid:movie_id>",
        views.getMovieRatingById,
        name="getMovieRatingById",
    ),
    # path('give_rating', views.RatingApiView.as_view() ,name = "ratingApiView2"),
    path(
        "give_rating_by_name/<str:movie_title>/<str:username>/<int:rating>",
        views.give_rating_by_name,
        name="give_rating_by_name",
    ),
    path(
        "give_rating_by_id/<str:movie_id>/<str:user_id>/<int:rating>",
        views.give_rating_by_id,
        name="give_rating_by_id",
    ),
]
